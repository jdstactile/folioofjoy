...
const WORK_ITEMS: WorkItem[] = [
  ...
  { src: '/work/verizon-red-02.png', caption: 'Verizon stock management app — helped inventory folks at retail stores scan and log stock without needing a training session or a paper trail.' },
  { src: '/work/urbyn-banner-02.png', caption: 'Full property search view — listings on the left, map on the right, filters that actually narrow things down instead of adding noise.' },
  { src: '/work/urbyn-value-drivers.png', caption: 'Value drivers breakdown — what pushes a property price up, what drags it down, laid out so you stop guessing and start negotiating.' },
  { src: '/work/urbyn-historical.png', caption: 'Historical value prediction — current price, last year, next year, and a chart that quietly outperforms the Zestimate.' },
  { src: '/work/email-illustration.png', caption: 'Marketing illustration for an email platform — clean enough to sit on a hero without fighting the headline for attention.' },
  { src: '/work/module-selector.png', caption: 'Module picker for a Danish manufacturing app — twenty-four slots, color-coded progress bars, zero room for misreading which one is done.' },
  { src: '/work/property-widgets.png', caption: 'Widgets for a real estate analytics platform — three chart types sharing one visual language without stepping on each other.' },
  { src: '/work/hotel-cards.jpg', caption: 'Widgets for a hotel concierge app — room status and food ordering in two cards that feel native to the stay, not bolted onto it.' },
  { src: '/work/carbon-dashboard.jpg', caption: 'Carbon emissions dashboard — spend, footprint per head, offsets, and a year-over-year bar chart that makes the CFO actually read the ESG report.' },
  { src: '/work/carbondash-brand.png', caption: 'Branding exploration for an Australian carbon accounting firm — the green grid that became the visual shorthand for everything they shipped.' },
  { src: '/work/carbondash-logos.png', caption: 'CarbonDash logo system — five weights, one mark, the kind of type exploration that makes the final pick feel obvious.' },
  { src: '/work/carbondash-marketing.png', caption: 'Framer site I built for the same carbon accounting firm — dark theme, feature sections, the full scroll from hero to integrations footer.' },
  { src: '/work/battalion-map.png', caption: 'Property intelligence on purple — the map view that made brokers close their spreadsheets and actually use the tool.' },
  { src: '/work/battalion-hero.png', caption: 'Hero for a proptech platform — isometric buildings, a search bar, and enough personality to not look like every other real estate SaaS.' },
  { src: '/work/platform-illustration.png', caption: 'Platform hero illustration — abstract enough for a landing page, specific enough to hint at what the product actually does.' },
  { src: '/work/battalion-messages.png', caption: 'Message centre for lender-broker comms — threaded by realty, because knowing which property you are talking about matters more than timestamps.' },
  { src: '/work/urbyn-development.png', caption: 'Zoning and development overlay — shows what is getting built near a property before the construction noise does.' },
  { src: '/work/data-dashboard-docs.png', caption: 'Onboarding cards for a datamarts tool on a data warehousing platform — naming conventions, metric setup, and dimensions illustrated so dry content feels approachable.' },
];
