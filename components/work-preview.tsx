...
const WORK_ITEMS: WorkItem[] = [
  ...
  { src: '/work/verizon-red-02.png', caption: 'Verizon retail scanner — scan by code or image, pick your rack from a store map, and get back to the floor before the next customer asks.' },
  ...
  { src: '/work/property-widgets.png', caption: 'Property value widget cards — three chart types sharing one visual language without stepping on each other.' },
  { src: '/work/hotel-cards.jpg', caption: 'Hotel guest experience cards — room status and breakfast ordering in two tiles that feel native to the stay, not bolted onto it.' },
  ...
  { src: '/work/carbondash-brand.png', caption: 'Brand pattern for CarbonDash — the green grid that became the visual shorthand for everything they shipped.' },
  ...
  { src: '/work/carbondash-marketing.png', caption: 'CarbonDash marketing site — dark theme, feature sections, the full scroll from hero to integrations footer.' },
  ...
  { src: '/work/data-dashboard-docs.png', caption: 'Onboarding docs for a data product — naming conventions, metric setup, and dimensions illustrated so dry content feels approachable.' },
];
